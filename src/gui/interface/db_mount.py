...
class DbMountInterface(QWidget):
    ...
    def init_ui(self):
        ...
        self.sourceDbCombo.setMinimumWidth(160)
        self.targetDbCombo.setMinimumWidth(160)
        self.examCombo.setMinimumWidth(240)
        ...
        self.connectionActionLayout = QHBoxLayout()
        self.databaseActionLayout = QHBoxLayout()
        self.examActionLayout = QHBoxLayout()
        ...
        self.connectionActionLayout.addWidget(self.refreshBtn)
        self.connectionActionLayout.addWidget(self.saveMountBtn)
        self.connectionActionLayout.addStretch(1)
        self.databaseActionLayout.addWidget(self.renameDbBtn)
        self.databaseActionLayout.addWidget(self.createDbBtn)
        self.databaseActionLayout.addWidget(self.exportDbBtn)
        self.databaseActionLayout.addWidget(self.importDbBtn)
        self.databaseActionLayout.addStretch(1)
        self.examActionLayout.addWidget(self.copyExamBtn)
        self.examActionLayout.addWidget(self.dryRunBtn)
        self.examActionLayout.addWidget(self.applyBtn)
        self.examActionLayout.addStretch(1)
        self.vBoxLayout.addWidget(BodyLabel("연결 설정", self))
        self.vBoxLayout.addLayout(self.connectionActionLayout)
        self.vBoxLayout.addWidget(BodyLabel("문제은행 파일 관리", self))
        self.vBoxLayout.addLayout(self.databaseActionLayout)
        self.vBoxLayout.addWidget(BodyLabel("시험 복사 및 이동", self))
        self.vBoxLayout.addLayout(self.examActionLayout)
