"""Import RonPark police engineering PDF questions into the SQLite question bank."""
...
DEFAULT_OUTPUT_DIR = Path("outputs/ronpark_police_engineering_20260702")
...
def backup_database(db_path: Path) -> Path:
    ...
    backup = db_path.with_name(f"{db_path.stem}.before_ronpark_police_engineering_{stamp}{db_path.suffix}")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("input_dir", type=Path, help="Folder containing the RonPark police engineering PDFs.")
