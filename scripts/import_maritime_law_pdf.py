"""Import offline maritime law PDF questions into the SQLite question bank."""
...
DEFAULT_OUTPUT_DIR = Path("outputs/maritime_law_pdf_20260702")
EXAM_CODE = "해양경찰 해사법규"
GENERIC_CHOICES = [
    "① 원문 보기 참조",
    "② 원문 보기 참조",
...
def backup_database(db_path: Path) -> Path:
    ...
    backup = db_path.with_name(f"{db_path.stem}.before_maritime_law_pdf_{stamp}{db_path.suffix}")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("input_dir", type=Path, help="Folder containing the offline maritime law PDFs.")
