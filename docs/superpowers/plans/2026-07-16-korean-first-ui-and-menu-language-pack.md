...
- [ ] **Step 1: Write failing loader, fallback, validation, and persistence tests**
...
- [ ] **Step 3: Implement immutable packs, strict JSON validation, Korean fallback, and atomic settings write**
...
- [ ] **Step 1: Write failing settings and navigation application tests**
...
- [ ] **Step 3: Implement settings dialog and route-key mapping**
...
- [ ] **Step 1: Write failing UI-copy, mode-discovery, and summary tests**
...
- [ ] **Step 3: Implement Korean labels and discoverable composition controls**
...
- [ ] **Step 1: Write failing terminology, step, and status tests**
...
- [ ] **Step 3: Implement Korean workflow and connection state**
...
- [ ] **Step 1: Write failing copy and preservation tests**
...
- [ ] **Step 3: Implement consistent editor and Codex copy**
...
- [ ] **Step 1: Write failing packaging and visible-copy audit tests**
...
- [ ] **Step 3: Bundle JSON resources and complete the copy audit**
...
- [ ] **Step 5: Run source launcher smoke checks**
...
- [ ] Re-read `docs/superpowers/specs/2026-07-16-korean-first-ui-and-menu-language-pack-design.md` and map every requirement to a completed task.
- [ ] Run `git diff --check` and confirm no whitespace errors.
- [ ] Run `.venv\Scripts\python.exe -m pytest -q` fresh and record the pass count.
- [ ] Run `git status --short` and confirm the only unrelated path is the user-owned untracked problem-bank ZIP.
- [ ] Inspect the final commit list and verify every production change has a preceding RED test in the execution log.
