...
- `scripts/import_gonggichul_pdf_folder.py`
- `scripts/import_ronpark_maritime_english.py`
- `scripts/import_ronpark_maritime_law.py`
- `scripts/import_ronpark_police_engineering.py`
- `scripts/import_ronpark_police_navigation.py`
...
해기사 PDF parser의 핵심은 `src/parser`입니다.
